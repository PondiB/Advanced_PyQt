...
class NameIt(qg.QDialog):
    def __init__(self):
        ...
        #setting up text layout for rename 
        ...
        mult_option_layout = qg.QHBoxLayout()
        mult_option_layout.setContentsMargins(4,0,4,0)
        mult_option_layout.setSpacing(2)
        rename_widget.layout().addLayout(mult_option_layout)
        ...
        mult_option_layout.addWidget(frame_pad_lb)
        mult_option_layout.addWidget(lower_radio)
        mult_option_layout.addSpacerItem(qg.QSpacerItem(5,5,qg.QSizePolicy.Expanding))
        mult_option_layout.addWidget(frame_pad_spin)
        mult_option_layout.addWidget(upper_radio)
        ...
        suffix_check = qg.QCheckBox('Prefix: ')
